            ...
            <div className="card">
               <Link to="/product/details/:id"> <img src={product.banner} className="card-img-top" alt="..."></img></Link>
                ...
                <div className="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" className="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-suit-heart" viewBox="0 0 16 16">
